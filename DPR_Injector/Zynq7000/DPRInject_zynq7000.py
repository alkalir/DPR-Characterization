...
BIT_STREAM_MAX_BYTES  =  0x00400000  # 4 MiB max pBS size
XST_FAILURE = 1
GLOBAL_bitOrBin = BIN
...
def HeadGeneration():
  ...
  headIndex += 1
  headBuf[headIndex] = 0x000000BB  # /*  09 */  /* Bus Width Sync Word */
  headIndex += 1
  headBuf[headIndex] = 0x11220044  # /*  10 */  /* Bus Width Detect */
  headIndex += 1
  headBuf[headIndex] = 0xFFFFFFFF  # /*  11 */  /* Dummy Word */
  headIndex += 1
  headBuf[headIndex] = 0xAA995566  # /*  12 */  /* Sync Word */
  headIndex += 1
  headBuf[headIndex] = 0x20000000  # /*  13 */  /* Type 1 NOOP Word 0 */
  headIndex += 1
...
def Generate_NOP_BS(sizeWords, bsnfo):
  ...
  bsnfo.valid = False
  if((sizeWords < 20) | ((sizeWords * 4) > BIT_STREAM_MAX_BYTES)):
